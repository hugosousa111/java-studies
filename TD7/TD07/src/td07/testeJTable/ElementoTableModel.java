...
public class ElementoTableModel extends AbstractTableModel {
    ...
    /** �ndice da coluna referente a s�mbolo. */
    public static final int SIMBOLO_INDEX = 0;
    /** �ndice da coluna referente a nome. */
    public static final int NOME_INDEX = 1;
    /** �ndice da coluna referente a n�mero at�mico. */
    public static final int NUMERO_ATOMICO_INDEX = 2;
    /** �ndice da coluna referente a massa at�mica. */
    public static final int MASSA_ATOMICA_INDEX = 3;
    /** �ndice da coluna referente a n�mero de per�odos. */
    public static final int NUM_DE_PERIODOS_INDEX = 4;
    /** �ndice da coluna referente a fam�lia. */
    public static final int FAMILIA_INDEX = 5;
    /** �ndice da coluna referente a chave prim�ria da tabela Elemento. */
    public static final int ID_INDEX = 6;
    
    private ArrayList linhas = null;
    private String[] colunas = null;
    
    /** Cria uma nova inst�ncia de ElementoTableModel */
     ...
     * @param row �ndice da linha a ser removida do modelo
     */
     ...
     * @param col �ndice da coluna a ser pesquisada
     ...
     * @param col �ndice da coluna a ser removida
